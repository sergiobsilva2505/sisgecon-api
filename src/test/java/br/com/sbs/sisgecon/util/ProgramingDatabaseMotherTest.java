...
public class ProgramingDatabaseMotherTest {
    ...
    public void create() {
        ...
        Container container8 = new Container("PMUU7412589", TypeContainer.TWENTY, StatusContainer.FULL, CategoryContainer.IMPORT, daniel);
        Container container9 = new Container("ABTU8529872", TypeContainer.FORTY, StatusContainer.EMPTY, CategoryContainer.IMPORT, daniel);
        Container container10 = new Container("TTNU4856547", TypeContainer.FORTY, StatusContainer.EMPTY, CategoryContainer.IMPORT, daniel);
        containerRepository.saveAll(
                Arrays.asList(container1, container2, container3, container4, container5, container6, container7, container8, container9, container10));
        ...
        List<Movement> movements = List.of(
                ...
                new Movement(TypeMovement.GATE_IN, LocalDateTime.of(2023, 9, 12, 20, 37, 58), LocalDateTime.of(2023, 9, 12, 20, 37, 58), StatusMovement.FINISHED, container7),
                new Movement(TypeMovement.GATE_IN, LocalDateTime.of(2023, 9, 12, 20, 37, 58), LocalDateTime.of(2023, 9, 12, 20, 37, 58), StatusMovement.FINISHED, container8),
                new Movement(TypeMovement.GATE_IN, LocalDateTime.of(2023, 9, 12, 20, 37, 58), LocalDateTime.of(2023, 9, 12, 20, 37, 58), StatusMovement.FINISHED, container9),
                new Movement(TypeMovement.GATE_IN, LocalDateTime.of(2023, 9, 12, 20, 37, 58), LocalDateTime.of(2023, 9, 12, 20, 37, 58), StatusMovement.FINISHED, container10),
                ...
                new Movement(TypeMovement.GATE_OUT, LocalDateTime.of(2023, 2, 12, 15, 27, 58), LocalDateTime.of(2023, 2, 12, 19, 45, 58), StatusMovement.FINISHED, container7),
                new Movement(TypeMovement.GATE_OUT, LocalDateTime.of(2023, 2, 12, 15, 27, 58), LocalDateTime.of(2023, 2, 12, 19, 45, 58), StatusMovement.FINISHED, container8),
                new Movement(TypeMovement.GATE_OUT, LocalDateTime.of(2023, 2, 12, 15, 27, 58), LocalDateTime.of(2023, 2, 12, 19, 45, 58), StatusMovement.FINISHED, container9),
                new Movement(TypeMovement.GATE_OUT, LocalDateTime.of(2023, 2, 12, 15, 27, 58), LocalDateTime.of(2023, 2, 12, 19, 45, 58), StatusMovement.FINISHED, container10),
                ...
                new Movement(TypeMovement.REPOSITIONING, LocalDateTime.of(2023, 2, 12, 15, 27, 58), LocalDateTime.of(2023, 2, 12, 19, 45, 58), StatusMovement.FINISHED, container7),
                new Movement(TypeMovement.REPOSITIONING, LocalDateTime.of(2023, 2, 12, 15, 27, 58), LocalDateTime.of(2023, 2, 12, 19, 45, 58), StatusMovement.FINISHED, container8),
                new Movement(TypeMovement.REPOSITIONING, LocalDateTime.of(2023, 2, 12, 15, 27, 58), LocalDateTime.of(2023, 2, 12, 19, 45, 58), StatusMovement.FINISHED, container9),
                new Movement(TypeMovement.REPOSITIONING, LocalDateTime.of(2023, 2, 12, 15, 27, 58), LocalDateTime.of(2023, 2, 12, 19, 45, 58), StatusMovement.FINISHED, container10),
                ...
                new Movement(TypeMovement.IN_WEIGHING, LocalDateTime.of(2023, 9, 12, 20, 37, 58), LocalDateTime.of(2023, 9, 12, 21, 45, 58), StatusMovement.FINISHED, container7),
                new Movement(TypeMovement.IN_WEIGHING, LocalDateTime.of(2023, 9, 12, 20, 37, 58), LocalDateTime.of(2023, 9, 12, 21, 45, 58), StatusMovement.FINISHED, container8),
                new Movement(TypeMovement.IN_WEIGHING, LocalDateTime.of(2023, 9, 12, 20, 37, 58), LocalDateTime.of(2023, 9, 12, 21, 45, 58), StatusMovement.FINISHED, container9),
                new Movement(TypeMovement.IN_WEIGHING, LocalDateTime.of(2023, 9, 12, 20, 37, 58), LocalDateTime.of(2023, 9, 12, 21, 45, 58), StatusMovement.FINISHED, container10),
                ...
                new Movement(TypeMovement.OUT_WEIGHING, LocalDateTime.of(2023, 9, 13, 9, 37, 58), LocalDateTime.of(2023, 9, 13, 10, 45, 58), StatusMovement.FINISHED, container7),
                new Movement(TypeMovement.OUT_WEIGHING, LocalDateTime.of(2023, 9, 13, 9, 37, 58), LocalDateTime.of(2023, 9, 13, 10, 45, 58), StatusMovement.FINISHED, container8),
                new Movement(TypeMovement.OUT_WEIGHING, LocalDateTime.of(2023, 9, 13, 9, 37, 58), LocalDateTime.of(2023, 9, 13, 10, 45, 58), StatusMovement.FINISHED, container9),
                new Movement(TypeMovement.OUT_WEIGHING, LocalDateTime.of(2023, 9, 13, 9, 37, 58), LocalDateTime.of(2023, 9, 13, 10, 45, 58), StatusMovement.FINISHED, container10),
                ...
                new Movement(TypeMovement.SCANNER, LocalDateTime.of(2023, 2, 12, 11, 27, 58), LocalDateTime.of(2023, 2, 12, 11, 45, 58), StatusMovement.FINISHED, container7),
                new Movement(TypeMovement.SCANNER, LocalDateTime.of(2023, 2, 12, 11, 27, 58), LocalDateTime.of(2023, 2, 12, 11, 45, 58), StatusMovement.FINISHED, container8),
                new Movement(TypeMovement.SCANNER, LocalDateTime.of(2023, 2, 12, 11, 27, 58), LocalDateTime.of(2023, 2, 12, 11, 45, 58), StatusMovement.FINISHED, container9),
                new Movement(TypeMovement.SCANNER, LocalDateTime.of(2023, 2, 12, 11, 27, 58), LocalDateTime.of(2023, 2, 12, 11, 45, 58), StatusMovement.FINISHED, container10),
                ...
                new Movement(TypeMovement.LOADING, LocalDateTime.of(2023, 2, 12, 15, 27, 58), LocalDateTime.of(2023, 2, 12, 19, 45, 58), StatusMovement.FINISHED, container7),
                new Movement(TypeMovement.LOADING, LocalDateTime.of(2023, 2, 12, 15, 27, 58), LocalDateTime.of(2023, 2, 12, 19, 45, 58), StatusMovement.FINISHED, container8),
                new Movement(TypeMovement.LOADING, LocalDateTime.of(2023, 2, 12, 15, 27, 58), LocalDateTime.of(2023, 2, 12, 19, 45, 58), StatusMovement.FINISHED, container9),
                new Movement(TypeMovement.LOADING, LocalDateTime.of(2023, 2, 12, 15, 27, 58), LocalDateTime.of(2023, 2, 12, 19, 45, 58), StatusMovement.FINISHED, container10),
                ...
                new Movement(TypeMovement.SHIPPING, LocalDateTime.of(2023, 2, 12, 15, 27, 58), LocalDateTime.of(2023, 2, 12, 19, 45, 58), StatusMovement.FINISHED, container7),
                new Movement(TypeMovement.SHIPPING, LocalDateTime.of(2023, 2, 12, 15, 27, 58), LocalDateTime.of(2023, 2, 12, 19, 45, 58), StatusMovement.FINISHED, container8),
                new Movement(TypeMovement.SHIPPING, LocalDateTime.of(2023, 2, 12, 15, 27, 58), LocalDateTime.of(2023, 2, 12, 19, 45, 58), StatusMovement.FINISHED, container9),
                new Movement(TypeMovement.SHIPPING, LocalDateTime.of(2023, 2, 12, 15, 27, 58), LocalDateTime.of(2023, 2, 12, 19, 45, 58), StatusMovement.FINISHED, container10),
                ...
                new Movement(TypeMovement.UNLOAD, LocalDateTime.of(2023, 2, 12, 15, 27, 58), LocalDateTime.of(2023, 2, 12, 19, 45, 58), StatusMovement.FINISHED, container7),
                new Movement(TypeMovement.UNLOAD, LocalDateTime.of(2023, 2, 12, 15, 27, 58), LocalDateTime.of(2023, 2, 12, 19, 45, 58), StatusMovement.FINISHED, container8),
                new Movement(TypeMovement.UNLOAD, LocalDateTime.of(2023, 2, 12, 15, 27, 58), LocalDateTime.of(2023, 2, 12, 19, 45, 58), StatusMovement.FINISHED, container9),
                new Movement(TypeMovement.UNLOAD, LocalDateTime.of(2023, 2, 12, 15, 27, 58), LocalDateTime.of(2023, 2, 12, 19, 45, 58), StatusMovement.FINISHED, container10));
